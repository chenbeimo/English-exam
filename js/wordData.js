      ...
      grade1: {
        ...
        books: [{
          ...
          units: [{
            name: '基础词汇',
            words: [
              { id: 1001, word: 'hello', phonetic: '/həˈloʊ/', meaning: '你好', example: 'Hello, how are you?', exampleCn: '你好，你好吗？' },
              { id: 1002, word: 'goodbye', phonetic: '/ɡʊdˈbaɪ/', meaning: '再见', example: 'Goodbye, see you tomorrow.', exampleCn: '再见，明天见。' },
              { id: 1003, word: 'apple', phonetic: '/ˈæpl/', meaning: '苹果', example: 'I eat an apple every day.', exampleCn: '我每天吃一个苹果。' },
              { id: 1004, word: 'book', phonetic: '/bʊk/', meaning: '书', example: 'This is my book.', exampleCn: '这是我的书。' },
              { id: 1005, word: 'cat', phonetic: '/kæt/', meaning: '猫', example: 'The cat is sleeping.', exampleCn: '猫在睡觉。' },
              { id: 1006, word: 'dog', phonetic: '/dɔːɡ/', meaning: '狗', example: 'I have a dog.', exampleCn: '我有一只狗。' },
              { id: 1007, word: 'red', phonetic: '/red/', meaning: '红色', example: 'The apple is red.', exampleCn: '苹果是红色的。' },
              { id: 1008, word: 'blue', phonetic: '/bluː/', meaning: '蓝色', example: 'The sky is blue.', exampleCn: '天空是蓝色的。' },
              { id: 1009, word: 'one', phonetic: '/wʌn/', meaning: '一', example: 'I have one brother.', exampleCn: '我有一个兄弟。' },
              { id: 1010, word: 'two', phonetic: '/tuː/', meaning: '二', example: 'Two birds are singing.', exampleCn: '两只鸟在唱歌。' },
              { id: 1011, word: 'three', phonetic: '/θriː/', meaning: '三', example: 'I have three pencils.', exampleCn: '我有三支铅笔。' },
              { id: 1012, word: 'yes', phonetic: '/jes/', meaning: '是的', example: 'Yes, I can do it.', exampleCn: '是的，我能做到。' },
              { id: 1013, word: 'no', phonetic: '/noʊ/', meaning: '不', example: 'No, thank you.', exampleCn: '不，谢谢。' },
              { id: 1014, word: 'please', phonetic: '/pliːz/', meaning: '请', example: 'Please sit down.', exampleCn: '请坐下。' },
              { id: 1015, word: 'thank', phonetic: '/θæŋk/', meaning: '谢谢', example: 'Thank you very much.', exampleCn: '非常感谢你。' }
            ]
          }]
        }]
      },
      grade2: {
        ...
        books: [{
          ...
          units: [{
            name: '常用词汇',
            words: [
              { id: 1101, word: 'family', phonetic: '/ˈfæməli/', meaning: '家庭', example: 'I love my family.', exampleCn: '我爱我的家。' },
              { id: 1102, word: 'mother', phonetic: '/ˈmʌðər/', meaning: '妈妈', example: 'My mother is a teacher.', exampleCn: '我妈妈是一名老师。' },
              { id: 1103, word: 'father', phonetic: '/ˈfɑːðər/', meaning: '爸爸', example: 'My father works hard.', exampleCn: '我爸爸工作很努力。' },
              { id: 1104, word: 'school', phonetic: '/skuːl/', meaning: '学校', example: 'I go to school every day.', exampleCn: '我每天去学校。' },
              { id: 1105, word: 'friend', phonetic: '/frend/', meaning: '朋友', example: 'She is my best friend.', exampleCn: '她是我最好的朋友。' },
              { id: 1106, word: 'happy', phonetic: '/ˈhæpi/', meaning: '开心的', example: 'I am very happy today.', exampleCn: '我今天很开心。' },
              { id: 1107, word: 'water', phonetic: '/ˈwɔːtər/', meaning: '水', example: 'Please give me some water.', exampleCn: '请给我一些水。' },
              { id: 1108, word: 'milk', phonetic: '/mɪlk/', meaning: '牛奶', example: 'I drink milk every morning.', exampleCn: '我每天早上喝牛奶。' },
              { id: 1109, word: 'big', phonetic: '/bɪɡ/', meaning: '大的', example: 'That is a big house.', exampleCn: '那是一座大房子。' },
              { id: 1110, word: 'small', phonetic: '/smɔːl/', meaning: '小的', example: 'The kitten is very small.', exampleCn: '小猫很小。' },
              { id: 1111, word: 'run', phonetic: '/rʌn/', meaning: '跑', example: 'I like to run in the park.', exampleCn: '我喜欢在公园里跑步。' },
              { id: 1112, word: 'eat', phonetic: '/iːt/', meaning: '吃', example: 'I eat lunch at 12.', exampleCn: '我12点吃午饭。' },
              { id: 1113, word: 'play', phonetic: '/pleɪ/', meaning: '玩', example: 'Let us play together.', exampleCn: '让我们一起玩吧。' },
              { id: 1114, word: 'bird', phonetic: '/bɜːrd/', meaning: '鸟', example: 'The bird can fly high.', exampleCn: '鸟能飞得很高。' },
              { id: 1115, word: 'fish', phonetic: '/fɪʃ/', meaning: '鱼', example: 'There are fish in the pond.', exampleCn: '池塘里有鱼。' }
            ]
          }]
        }]
      },
      grade3: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 1201, word: 'ruler', phonetic: '/ˈruːlər/', meaning: '尺子', example: 'I need a ruler for math class.', exampleCn: '我数学课需要一把尺子。' },
              { id: 1202, word: 'pencil', phonetic: '/ˈpensl/', meaning: '铅笔', example: 'Write your name with a pencil.', exampleCn: '用铅笔写下你的名字。' },
              { id: 1203, word: 'eraser', phonetic: '/ɪˈreɪsər/', meaning: '橡皮', example: 'Can I borrow your eraser?', exampleCn: '我能借你的橡皮吗？' },
              { id: 1204, word: 'crayon', phonetic: '/ˈkreɪɑːn/', meaning: '蜡笔', example: 'Color the picture with crayons.', exampleCn: '用蜡笔给画上色。' },
              { id: 1205, word: 'head', phonetic: '/hed/', meaning: '头', example: 'Nod your head if you agree.', exampleCn: '如果你同意就点头。' },
              { id: 1206, word: 'face', phonetic: '/feɪs/', meaning: '脸', example: 'She has a beautiful face.', exampleCn: '她有一张漂亮的脸。' },
              { id: 1207, word: 'eye', phonetic: '/aɪ/', meaning: '眼睛', example: 'Close your eyes and relax.', exampleCn: '闭上眼睛放松一下。' },
              { id: 1208, word: 'ear', phonetic: '/ɪr/', meaning: '耳朵', example: 'Rabbits have long ears.', exampleCn: '兔子有长长的耳朵。' },
              { id: 1209, word: 'nose', phonetic: '/noʊz/', meaning: '鼻子', example: 'The dog has a wet nose.', exampleCn: '狗有一个湿鼻子。' },
              { id: 1210, word: 'mouth', phonetic: '/maʊθ/', meaning: '嘴', example: 'Open your mouth, please.', exampleCn: '请张开嘴。' },
              { id: 1211, word: 'hand', phonetic: '/hænd/', meaning: '手', example: 'Wash your hands before eating.', exampleCn: '饭前洗手。' },
              { id: 1212, word: 'arm', phonetic: '/ɑːrm/', meaning: '手臂', example: 'He broke his arm last week.', exampleCn: '他上周摔断了手臂。' },
              { id: 1213, word: 'leg', phonetic: '/leɡ/', meaning: '腿', example: 'She hurt her leg in the game.', exampleCn: '她在比赛中伤了腿。' },
              { id: 1214, word: 'foot', phonetic: '/fʊt/', meaning: '脚', example: 'My foot is sore from walking.', exampleCn: '我的脚走路走疼了。' },
              { id: 1215, word: 'body', phonetic: '/ˈbɑːdi/', meaning: '身体', example: 'Exercise is good for your body.', exampleCn: '运动对身体有好处。' }
            ]
          },{
            name: 'Unit 2',
            words: [
              { id: 1216, word: 'black', phonetic: '/blæk/', meaning: '黑色', example: 'He wore a black suit.', exampleCn: '他穿着一套黑色西装。' },
              { id: 1217, word: 'white', phonetic: '/waɪt/', meaning: '白色', example: 'Snow is white and beautiful.', exampleCn: '雪是白色而美丽的。' },
              { id: 1218, word: 'orange', phonetic: '/ˈɔːrɪndʒ/', meaning: '橙色；橙子', example: 'Orange juice is my favorite.', exampleCn: '橙汁是我的最爱。' },
              { id: 1219, word: 'green', phonetic: '/ɡriːn/', meaning: '绿色', example: 'The grass is green in spring.', exampleCn: '春天草地是绿色的。' },
              { id: 1220, word: 'yellow', phonetic: '/ˈjeloʊ/', meaning: '黄色', example: 'The banana is yellow.', exampleCn: '香蕉是黄色的。' },
              { id: 1221, word: 'pink', phonetic: '/pɪŋk/', meaning: '粉色', example: 'She likes pink dresses.', exampleCn: '她喜欢粉色裙子。' },
              { id: 1222, word: 'brown', phonetic: '/braʊn/', meaning: '棕色', example: 'The bear is brown.', exampleCn: '熊是棕色的。' },
              { id: 1223, word: 'purple', phonetic: '/ˈpɜːrpl/', meaning: '紫色', example: 'Grapes come in purple and green.', exampleCn: '葡萄有紫色和绿色的。' },
              { id: 1224, word: 'four', phonetic: '/fɔːr/', meaning: '四', example: 'A dog has four legs.', exampleCn: '狗有四条腿。' },
              { id: 1225, word: 'five', phonetic: '/faɪv/', meaning: '五', example: 'I have five fingers on each hand.', exampleCn: '我每只手有五根手指。' },
              { id: 1226, word: 'six', phonetic: '/sɪks/', meaning: '六', example: 'Six students are in the room.', exampleCn: '六个学生在房间里。' },
              { id: 1227, word: 'seven', phonetic: '/ˈsevn/', meaning: '七', example: 'There are seven days in a week.', exampleCn: '一周有七天。' },
              { id: 1228, word: 'eight', phonetic: '/eɪt/', meaning: '八', example: 'An octopus has eight arms.', exampleCn: '章鱼有八条手臂。' },
              { id: 1229, word: 'nine', phonetic: '/naɪn/', meaning: '九', example: 'Nine planets orbit the sun.', exampleCn: '九大行星绕太阳运行。' },
              { id: 1230, word: 'ten', phonetic: '/ten/', meaning: '十', example: 'Count from one to ten.', exampleCn: '从一数到十。' }
            ]
          }]
        }]
      },
      grade4: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 1301, word: 'classroom', phonetic: '/ˈklæsruːm/', meaning: '教室', example: 'Our classroom is on the second floor.', exampleCn: '我们教室在二楼。' },
              { id: 1302, word: 'window', phonetic: '/ˈwɪndoʊ/', meaning: '窗户', example: 'Please open the window.', exampleCn: '请打开窗户。' },
              { id: 1303, word: 'door', phonetic: '/dɔːr/', meaning: '门', example: 'Close the door behind you.', exampleCn: '随手关门。' },
              { id: 1304, word: 'picture', phonetic: '/ˈpɪktʃər/', meaning: '图画', example: 'Draw a picture of your family.', exampleCn: '画一幅你家人的画。' },
              { id: 1305, word: 'board', phonetic: '/bɔːrd/', meaning: '黑板', example: 'Look at the board, please.', exampleCn: '请看黑板。' },
              { id: 1306, word: 'light', phonetic: '/laɪt/', meaning: '灯；光', example: 'Turn on the light, please.', exampleCn: '请开灯。' },
              { id: 1307, word: 'floor', phonetic: '/flɔːr/', meaning: '地板；楼层', example: 'Sweep the floor clean.', exampleCn: '把地板扫干净。' },
              { id: 1308, word: 'wall', phonetic: '/wɔːl/', meaning: '墙', example: 'Hang the picture on the wall.', exampleCn: '把画挂在墙上。' },
              { id: 1309, word: 'computer', phonetic: '/kəmˈpjuːtər/', meaning: '电脑', example: 'I use a computer to do homework.', exampleCn: '我用电脑做作业。' },
              { id: 1310, word: 'teacher', phonetic: '/ˈtiːtʃər/', meaning: '老师', example: 'Our teacher is very kind.', exampleCn: '我们的老师很和蔼。' },
              { id: 1311, word: 'student', phonetic: '/ˈstuːdnt/', meaning: '学生', example: 'He is a good student.', exampleCn: '他是一个好学生。' },
              { id: 1312, word: 'quiet', phonetic: '/ˈkwaɪət/', meaning: '安静的', example: 'Please be quiet in the library.', exampleCn: '请在图书馆保持安静。' },
              { id: 1313, word: 'clean', phonetic: '/kliːn/', meaning: '干净的；打扫', example: 'Keep your room clean and tidy.', exampleCn: '保持你的房间干净整洁。' },
              { id: 1314, word: 'strong', phonetic: '/strɑːŋ/', meaning: '强壮的', example: 'He is tall and strong.', exampleCn: '他又高又壮。' },
              { id: 1315, word: 'quietly', phonetic: '/ˈkwaɪətli/', meaning: '安静地', example: 'Walk quietly in the hallway.', exampleCn: '在走廊里安静地走。' }
            ]
          },{
            name: 'Unit 2',
            words: [
              { id: 1316, word: 'breakfast', phonetic: '/ˈbrekfəst/', meaning: '早餐', example: 'I have breakfast at 7 every day.', exampleCn: '我每天7点吃早餐。' },
              { id: 1317, word: 'lunch', phonetic: '/lʌntʃ/', meaning: '午餐', example: 'What did you eat for lunch?', exampleCn: '你午餐吃了什么？' },
              { id: 1318, word: 'dinner', phonetic: '/ˈdɪnər/', meaning: '晚餐', example: 'We have dinner together as a family.', exampleCn: '我们一家人一起吃晚餐。' },
              { id: 1319, word: 'rice', phonetic: '/raɪs/', meaning: '米饭', example: 'Chinese people eat rice every day.', exampleCn: '中国人每天吃米饭。' },
              { id: 1320, word: 'noodle', phonetic: '/ˈnuːdl/', meaning: '面条', example: 'I like beef noodles very much.', exampleCn: '我非常喜欢牛肉面。' },
              { id: 1321, word: 'chicken', phonetic: '/ˈtʃɪkɪn/', meaning: '鸡肉；小鸡', example: 'Fried chicken is delicious.', exampleCn: '炸鸡很好吃。' },
              { id: 1322, word: 'vegetable', phonetic: '/ˈvedʒtəbl/', meaning: '蔬菜', example: 'Eat more vegetables for health.', exampleCn: '为了健康多吃蔬菜。' },
              { id: 1323, word: 'soup', phonetic: '/suːp/', meaning: '汤', example: 'Would you like some soup?', exampleCn: '你想喝点汤吗？' },
              { id: 1324, word: 'spoon', phonetic: '/spuːn/', meaning: '勺子', example: 'Use a spoon to stir the tea.', exampleCn: '用勺子搅拌茶。' },
              { id: 1325, word: 'chopsticks', phonetic: '/ˈtʃɑːpstɪks/', meaning: '筷子', example: 'Can you use chopsticks?', exampleCn: '你会用筷子吗？' },
              { id: 1326, word: 'kitchen', phonetic: '/ˈkɪtʃɪn/', meaning: '厨房', example: 'My mom is cooking in the kitchen.', exampleCn: '我妈妈在厨房做饭。' },
              { id: 1327, word: 'bedroom', phonetic: '/ˈbedruːm/', meaning: '卧室', example: 'My bedroom is small but cozy.', exampleCn: '我的卧室虽小但很温馨。' },
              { id: 1328, word: 'bathroom', phonetic: '/ˈbæθruːm/', meaning: '浴室', example: 'The bathroom is next to my room.', exampleCn: '浴室在我房间旁边。' },
              { id: 1329, word: 'phone', phonetic: '/foʊn/', meaning: '电话', example: 'Can I use your phone?', exampleCn: '我能用一下你的电话吗？' },
              { id: 1330, word: 'table', phonetic: '/ˈteɪbl/', meaning: '桌子', example: 'Put the book on the table.', exampleCn: '把书放在桌子上。' }
            ]
          }]
        }]
      },
      grade5: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 1401, word: 'Monday', phonetic: '/ˈmʌndeɪ/', meaning: '星期一', example: 'We have English class on Monday.', exampleCn: '我们星期一有英语课。' },
              { id: 1402, word: 'Tuesday', phonetic: '/ˈtuːzdeɪ/', meaning: '星期二', example: 'Tuesday is my busiest day.', exampleCn: '星期二是我最忙的一天。' },
              { id: 1403, word: 'Wednesday', phonetic: '/ˈwenzdeɪ/', meaning: '星期三', example: 'The meeting is on Wednesday.', exampleCn: '会议在星期三。' },
              { id: 1404, word: 'Thursday', phonetic: '/ˈθɜːrzdeɪ/', meaning: '星期四', example: 'I have piano lessons on Thursday.', exampleCn: '我星期四有钢琴课。' },
              { id: 1405, word: 'Friday', phonetic: '/ˈfraɪdeɪ/', meaning: '星期五', example: 'Friday is my favorite day!', exampleCn: '星期五是我最喜欢的一天！' },
              { id: 1406, word: 'Saturday', phonetic: '/ˈsætərdeɪ/', meaning: '星期六', example: 'We go shopping on Saturday.', exampleCn: '我们星期六去购物。' },
              { id: 1407, word: 'Sunday', phonetic: '/ˈsʌndeɪ/', meaning: '星期天', example: 'Sunday is a day of rest.', exampleCn: '星期天是休息日。' },
              { id: 1408, word: 'today', phonetic: '/təˈdeɪ/', meaning: '今天', example: 'Today is a beautiful day.', exampleCn: '今天是美好的一天。' },
              { id: 1409, word: 'tomorrow', phonetic: '/təˈmɑːroʊ/', meaning: '明天', example: 'See you tomorrow morning.', exampleCn: '明天早上见。' },
              { id: 1410, word: 'yesterday', phonetic: '/ˈjestərdeɪ/', meaning: '昨天', example: 'I went to the park yesterday.', exampleCn: '我昨天去了公园。' },
              { id: 1411, word: 'season', phonetic: '/ˈsiːzn/', meaning: '季节', example: 'Spring is my favorite season.', exampleCn: '春天是我最喜欢的季节。' },
              { id: 1412, word: 'spring', phonetic: '/sprɪŋ/', meaning: '春天', example: 'Flowers bloom in spring.', exampleCn: '春天花开。' },
              { id: 1413, word: 'summer', phonetic: '/ˈsʌmər/', meaning: '夏天', example: 'It is very hot in summer.', exampleCn: '夏天非常热。' },
              { id: 1414, word: 'autumn', phonetic: '/ˈɔːtəm/', meaning: '秋天', example: 'Leaves fall in autumn.', exampleCn: '秋天叶子飘落。' },
              { id: 1415, word: 'winter', phonetic: '/ˈwɪntər/', meaning: '冬天', example: 'It snows a lot in winter.', exampleCn: '冬天下很多雪。' }
            ]
          },{
            name: 'Unit 2',
            words: [
              { id: 1416, word: 'weather', phonetic: '/ˈweðər/', meaning: '天气', example: 'The weather is sunny today.', exampleCn: '今天天气晴朗。' },
              { id: 1417, word: 'sunny', phonetic: '/ˈsʌni/', meaning: '晴朗的', example: 'It is a sunny afternoon.', exampleCn: '这是一个晴朗的下午。' },
              { id: 1418, word: 'rainy', phonetic: '/ˈreɪni/', meaning: '下雨的', example: 'Take an umbrella on rainy days.', exampleCn: '下雨天带把伞。' },
              { id: 1419, word: 'cloudy', phonetic: '/ˈklaʊdi/', meaning: '多云的', example: 'The sky is cloudy today.', exampleCn: '今天天空多云。' },
              { id: 1420, word: 'windy', phonetic: '/ˈwɪndi/', meaning: '有风的', example: 'It is too windy to go out.', exampleCn: '风太大了出不去。' },
              { id: 1421, word: 'snowy', phonetic: '/ˈsnoʊi/', meaning: '下雪的', example: 'A snowy day is perfect for skiing.', exampleCn: '下雪天最适合滑雪。' },
              { id: 1422, word: 'mountain', phonetic: '/ˈmaʊntn/', meaning: '山', example: 'We climbed the mountain last week.', exampleCn: '我们上周爬了山。' },
              { id: 1423, word: 'river', phonetic: '/ˈrɪvər/', meaning: '河流', example: 'The river flows through the city.', exampleCn: '这条河流经城市。' },
              { id: 1424, word: 'lake', phonetic: '/leɪk/', meaning: '湖', example: 'We went fishing at the lake.', exampleCn: '我们去湖边钓鱼了。' },
              { id: 1425, word: 'forest', phonetic: '/ˈfɔːrɪst/', meaning: '森林', example: 'Many animals live in the forest.', exampleCn: '许多动物生活在森林里。' },
              { id: 1426, word: 'bridge', phonetic: '/brɪdʒ/', meaning: '桥', example: 'Cross the bridge and turn right.', exampleCn: '过桥后右转。' },
              { id: 1427, word: 'building', phonetic: '/ˈbɪldɪŋ/', meaning: '建筑物', example: 'That building is very tall.', exampleCn: '那栋建筑非常高。' },
              { id: 1428, word: 'village', phonetic: '/ˈvɪlɪdʒ/', meaning: '村庄', example: 'My grandparents live in a small village.', exampleCn: '我的祖父母住在一个小村庄。' },
              { id: 1429, word: 'hotel', phonetic: '/hoʊˈtel/', meaning: '旅馆', example: 'We stayed at a nice hotel.', exampleCn: '我们住在一家不错的旅馆。' },
              { id: 1430, word: 'hospital', phonetic: '/ˈhɑːspɪtl/', meaning: '医院', example: 'She works at the city hospital.', exampleCn: '她在市医院工作。' }
            ]
          }]
        }]
      },
      grade6: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 1501, word: 'science', phonetic: '/ˈsaɪəns/', meaning: '科学', example: 'Science is my favorite subject.', exampleCn: '科学是我最喜欢的科目。' },
              { id: 1502, word: 'museum', phonetic: '/mjuˈziːəm/', meaning: '博物馆', example: 'We visited the science museum.', exampleCn: '我们参观了科学博物馆。' },
              { id: 1503, word: 'library', phonetic: '/ˈlaɪbreri/', meaning: '图书馆', example: 'I study at the library after school.', exampleCn: '我放学后在图书馆学习。' },
              { id: 1504, word: 'supermarket', phonetic: '/ˈsuːpərmɑːrkɪt/', meaning: '超市', example: 'Let us go to the supermarket.', exampleCn: '我们去超市吧。' },
              { id: 1505, word: 'bookstore', phonetic: '/ˈbʊkstɔːr/', meaning: '书店', example: 'I bought this book at the bookstore.', exampleCn: '我在书店买了这本书。' },
              { id: 1506, word: 'cinema', phonetic: '/ˈsɪnəmə/', meaning: '电影院', example: 'Shall we go to the cinema tonight?', exampleCn: '我们今晚去看电影好吗？' },
              { id: 1507, word: 'restaurant', phonetic: '/ˈrestrɑːnt/', meaning: '餐厅', example: 'This restaurant serves good food.', exampleCn: '这家餐厅的菜不错。' },
              { id: 1508, word: 'airport', phonetic: '/ˈerpɔːrt/', meaning: '机场', example: 'We arrived at the airport early.', exampleCn: '我们很早就到了机场。' },
              { id: 1509, word: 'station', phonetic: '/ˈsteɪʃn/', meaning: '车站', example: 'The train station is near here.', exampleCn: '火车站在这附近。' },
              { id: 1510, word: 'straight', phonetic: '/streɪt/', meaning: '直的；直接', example: 'Go straight and turn left.', exampleCn: '直走然后左转。' },
              { id: 1511, word: 'crossing', phonetic: '/ˈkrɔːsɪŋ/', meaning: '十字路口', example: 'Turn right at the first crossing.', exampleCn: '在第一个十字路口右转。' },
              { id: 1512, word: 'direction', phonetic: '/dɪˈrekʃn/', meaning: '方向', example: 'Which direction should we go?', exampleCn: '我们应该朝哪个方向走？' },
              { id: 1513, word: 'left', phonetic: '/left/', meaning: '左边', example: 'The bank is on your left.', exampleCn: '银行在你左边。' },
              { id: 1514, word: 'right', phonetic: '/raɪt/', meaning: '右边；正确的', example: 'Turn right at the corner.', exampleCn: '在拐角处右转。' },
              { id: 1515, word: 'address', phonetic: '/ˈædres/', meaning: '地址', example: 'What is your home address?', exampleCn: '你的家庭地址是什么？' }
            ]
          },{
            name: 'Unit 2',
            words: [
              { id: 1516, word: 'hobby', phonetic: '/ˈhɑːbi/', meaning: '爱好', example: 'My hobby is reading books.', exampleCn: '我的爱好是读书。' },
              { id: 1517, word: 'swimming', phonetic: '/ˈswɪmɪŋ/', meaning: '游泳', example: 'Swimming is good exercise.', exampleCn: '游泳是很好的锻炼。' },
              { id: 1518, word: 'dancing', phonetic: '/ˈdænsɪŋ/', meaning: '跳舞', example: 'She enjoys dancing very much.', exampleCn: '她非常喜欢跳舞。' },
              { id: 1519, word: 'singing', phonetic: '/ˈsɪŋɪŋ/', meaning: '唱歌', example: 'He is good at singing.', exampleCn: '他擅长唱歌。' },
              { id: 1520, word: 'drawing', phonetic: '/ˈdrɔːɪŋ/', meaning: '绘画', example: 'Drawing helps me relax.', exampleCn: '绘画帮助我放松。' },
              { id: 1521, word: 'football', phonetic: '/ˈfʊtbɔːl/', meaning: '足球', example: 'We play football every weekend.', exampleCn: '我们每周末踢足球。' },
              { id: 1522, word: 'basketball', phonetic: '/ˈbæskɪtbɔːl/', meaning: '篮球', example: 'He is learning to play basketball.', exampleCn: '他在学习打篮球。' },
              { id: 1523, word: 'player', phonetic: '/ˈpleɪər/', meaning: '选手；播放器', example: 'She is the best player on the team.', exampleCn: '她是队里最好的选手。' },
              { id: 1524, word: 'doctor', phonetic: '/ˈdɑːktər/', meaning: '医生', example: 'I want to be a doctor in the future.', exampleCn: '我将来想当医生。' },
              { id: 1525, word: 'pilot', phonetic: '/ˈpaɪlət/', meaning: '飞行员', example: 'The pilot landed the plane safely.', exampleCn: '飞行员安全降落了飞机。' },
              { id: 1526, word: 'scientist', phonetic: '/ˈsaɪəntɪst/', meaning: '科学家', example: 'Einstein was a great scientist.', exampleCn: '爱因斯坦是一位伟大的科学家。' },
              { id: 1527, word: 'writer', phonetic: '/ˈraɪtər/', meaning: '作家', example: 'She wants to be a famous writer.', exampleCn: '她想成为著名作家。' },
              { id: 1528, word: 'angry', phonetic: '/ˈæŋɡri/', meaning: '生气的', example: 'He looked very angry at me.', exampleCn: '他看起来对我很生气。' },
              { id: 1529, word: 'afraid', phonetic: '/əˈfreɪd/', meaning: '害怕的', example: 'I am afraid of snakes.', exampleCn: '我害怕蛇。' },
              { id: 1530, word: 'worried', phonetic: '/ˈwɜːrid/', meaning: '担心的', example: 'She is worried about her exam.', exampleCn: '她担心她的考试。' }
            ]
          }]
        }]
      }
      ...
      grade7: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 2001, word: 'spell', phonetic: '/spel/', meaning: '拼写', example: 'Can you spell your name?', exampleCn: '你能拼写你的名字吗？' },
              { id: 2002, word: 'dictionary', phonetic: '/ˈdɪkʃəneri/', meaning: '词典', example: 'Look up the word in the dictionary.', exampleCn: '在词典里查这个词。' },
              { id: 2003, word: 'notebook', phonetic: '/ˈnoʊtbʊk/', meaning: '笔记本', example: 'Write it down in your notebook.', exampleCn: '把它写在你的笔记本上。' },
              { id: 2004, word: 'excuse', phonetic: '/ɪkˈskjuːs/', meaning: '原谅；借口', example: 'Excuse me, where is the bank?', exampleCn: '劳驾，银行在哪里？' },
              { id: 2005, word: 'watch', phonetic: '/wɑːtʃ/', meaning: '手表；观看', example: 'My watch says it is 3 PM.', exampleCn: '我的手表显示是下午3点。' },
              { id: 2006, word: 'these', phonetic: '/ðiːz/', meaning: '这些', example: 'These books are mine.', exampleCn: '这些书是我的。' },
              { id: 2007, word: 'those', phonetic: '/ðoʊz/', meaning: '那些', example: 'Those flowers are beautiful.', exampleCn: '那些花很漂亮。' },
              { id: 2008, word: 'always', phonetic: '/ˈɔːlweɪz/', meaning: '总是', example: 'She is always on time.', exampleCn: '她总是准时。' },
              { id: 2009, word: 'usually', phonetic: '/ˈjuːʒuəli/', meaning: '通常', example: 'I usually wake up at 6 AM.', exampleCn: '我通常早上6点起床。' },
              { id: 2010, word: 'sometimes', phonetic: '/ˈsʌmtaɪmz/', meaning: '有时', example: 'Sometimes I ride my bike to school.', exampleCn: '有时我骑自行车上学。' },
              { id: 2011, word: 'never', phonetic: '/ˈnevər/', meaning: '从不', example: 'I never eat junk food.', exampleCn: '我从不吃垃圾食品。' },
              { id: 2012, word: 'often', phonetic: '/ˈɔːfn/', meaning: '经常', example: 'How often do you exercise?', exampleCn: '你多久锻炼一次？' },
              { id: 2013, word: 'healthy', phonetic: '/ˈhelθi/', meaning: '健康的', example: 'Eating fruit is a healthy habit.', exampleCn: '吃水果是一种健康习惯。' },
              { id: 2014, word: 'delicious', phonetic: '/dɪˈlɪʃəs/', meaning: '美味的', example: 'The cake is very delicious.', exampleCn: '这个蛋糕非常好吃。' },
              { id: 2015, word: 'terrible', phonetic: '/ˈterəbl/', meaning: '糟糕的', example: 'The weather is terrible today.', exampleCn: '今天天气糟透了。' },
              { id: 2016, word: 'important', phonetic: '/ɪmˈpɔːrtnt/', meaning: '重要的', example: 'Education is very important.', exampleCn: '教育非常重要。' },
              { id: 2017, word: 'different', phonetic: '/ˈdɪfrənt/', meaning: '不同的', example: 'Everyone has a different opinion.', exampleCn: '每个人都有不同的意见。' },
              { id: 2018, word: 'popular', phonetic: '/ˈpɑːpjələr/', meaning: '流行的；受欢迎的', example: 'This song is very popular among teenagers.', exampleCn: '这首歌在青少年中非常流行。' },
              { id: 2019, word: 'natural', phonetic: '/ˈnætʃrəl/', meaning: '自然的', example: 'This is a natural phenomenon.', exampleCn: '这是一种自然现象。' },
              { id: 2020, word: 'comfortable', phonetic: '/ˈkʌmftəbl/', meaning: '舒适的', example: 'This chair is very comfortable.', exampleCn: '这把椅子非常舒适。' }
            ]
          }]
        }]
      },
      grade8: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 2101, word: 'activity', phonetic: '/ækˈtɪvəti/', meaning: '活动', example: 'There are many after-school activities.', exampleCn: '有很多课外活动。' },
              { id: 2102, word: 'decide', phonetic: '/dɪˈsaɪd/', meaning: '决定', example: 'I decided to study abroad.', exampleCn: '我决定出国留学。' },
              { id: 2103, word: 'difference', phonetic: '/ˈdɪfrəns/', meaning: '差异', example: 'What is the difference between A and B?', exampleCn: 'A和B之间有什么区别？' },
              { id: 2104, word: 'environment', phonetic: '/ɪnˈvaɪrənmənt/', meaning: '环境', example: 'We should protect the environment.', exampleCn: '我们应该保护环境。' },
              { id: 2105, word: 'experience', phonetic: '/ɪkˈspɪriəns/', meaning: '经验；经历', example: 'Traveling is a great experience.', exampleCn: '旅行是一种很棒的体验。' },
              { id: 2106, word: 'foreign', phonetic: '/ˈfɔːrən/', meaning: '外国的', example: 'She can speak two foreign languages.', exampleCn: '她会说两种外语。' },
              { id: 2107, word: 'government', phonetic: '/ˈɡʌvərnmənt/', meaning: '政府', example: 'The government is taking action on pollution.', exampleCn: '政府正在对污染采取行动。' },
              { id: 2108, word: 'impossible', phonetic: '/ɪmˈpɑːsəbl/', meaning: '不可能的', example: 'Nothing is impossible if you try.', exampleCn: '如果你尝试，没有什么是不可可能的。' },
              { id: 2109, word: 'independent', phonetic: '/ˌɪndɪˈpendənt/', meaning: '独立的', example: 'She is a strong and independent woman.', exampleCn: '她是一个坚强独立的女性。' },
              { id: 2110, word: 'knowledge', phonetic: '/ˈnɑːlɪdʒ/', meaning: '知识', example: 'Knowledge is power.', exampleCn: '知识就是力量。' },
              { id: 2111, word: 'language', phonetic: '/ˈlæŋɡwɪdʒ/', meaning: '语言', example: 'Learning a new language takes time.', exampleCn: '学习一门新语言需要时间。' },
              { id: 2112, word: 'necessary', phonetic: '/ˈnesəseri/', meaning: '必要的', example: 'Water is necessary for life.', exampleCn: '水是生命所必需的。' },
              { id: 2113, word: 'opinion', phonetic: '/əˈpɪnjən/', meaning: '意见', example: 'In my opinion, this is a good plan.', exampleCn: '在我看来，这是个好计划。' },
              { id: 2114, word: 'possible', phonetic: '/ˈpɑːsəbl/', meaning: '可能的', example: 'Is it possible to finish today?', exampleCn: '今天有可能完成吗？' },
              { id: 2115, word: 'practice', phonetic: '/ˈpræktɪs/', meaning: '练习；实践', example: 'Practice makes perfect.', exampleCn: '熟能生巧。' },
              { id: 2116, word: 'problem', phonetic: '/ˈprɑːbləm/', meaning: '问题', example: 'We need to solve this problem quickly.', exampleCn: '我们需要快速解决这个问题。' },
              { id: 2117, word: 'relationship', phonetic: '/rɪˈleɪʃnʃɪp/', meaning: '关系', example: 'They have a good relationship.', exampleCn: '他们关系很好。' },
              { id: 2118, word: 'situation', phonetic: '/ˌsɪtʃuˈeɪʃn/', meaning: '情况', example: 'The situation is under control.', exampleCn: '情况在控制之中。' },
              { id: 2119, word: 'successful', phonetic: '/səkˈsesfl/', meaning: '成功的', example: 'She is a successful businesswoman.', exampleCn: '她是一位成功的女商人。' },
              { id: 2120, word: 'technology', phonetic: '/tekˈnɑːlədʒi/', meaning: '技术', example: 'Technology is changing our lives rapidly.', exampleCn: '技术正在迅速改变我们的生活。' }
            ]
          }]
        }]
      },
      grade9: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 2201, word: 'pronunciation', phonetic: '/prəˌnʌnsiˈeɪʃn/', meaning: '发音', example: 'Your pronunciation is very good.', exampleCn: '你的发音非常好。' },
              { id: 2202, word: 'expression', phonetic: '/ɪkˈspreʃn/', meaning: '表达；表情', example: 'She has a happy expression on her face.', exampleCn: '她脸上有快乐的表情。' },
              { id: 2203, word: 'discover', phonetic: '/dɪˈskʌvər/', meaning: '发现', example: 'Scientists discovered a new planet.', exampleCn: '科学家发现了一颗新行星。' },
              { id: 2204, word: 'conversation', phonetic: '/ˌkɑːnvərˈseɪʃn/', meaning: '对话', example: 'We had a long conversation.', exampleCn: '我们进行了一次长谈。' },
              { id: 2205, word: 'grammar', phonetic: '/ˈɡræmər/', meaning: '语法', example: 'Grammar is important for writing well.', exampleCn: '语法对写作很重要。' },
              { id: 2206, word: 'secret', phonetic: '/ˈsiːkrət/', meaning: '秘密', example: 'Can you keep a secret?', exampleCn: '你能保守秘密吗？' },
              { id: 2207, word: 'patient', phonetic: '/ˈpeɪʃnt/', meaning: '耐心的；病人', example: 'You need to be more patient.', exampleCn: '你需要更有耐心。' },
              { id: 2208, word: 'active', phonetic: '/ˈæktɪv/', meaning: '活跃的', example: 'She is an active member of the club.', exampleCn: '她是俱乐部的活跃成员。' },
              { id: 2209, word: 'connect', phonetic: '/kəˈnekt/', meaning: '连接', example: 'The internet connects people worldwide.', exampleCn: '互联网连接了全世界的人。' },
              { id: 2210, word: 'review', phonetic: '/rɪˈvjuː/', meaning: '复习；评论', example: 'Let us review what we learned today.', exampleCn: '让我们回顾一下今天学的内容。' },
              { id: 2211, word: 'attention', phonetic: '/əˈtenʃn/', meaning: '注意力', example: 'Pay attention to the teacher.', exampleCn: '注意听老师讲课。' },
              { id: 2212, word: 'ability', phonetic: '/əˈbɪləti/', meaning: '能力', example: 'She has the ability to learn fast.', exampleCn: '她有快速学习的能力。' },
              { id: 2213, word: 'encourage', phonetic: '/ɪnˈkɜːrɪdʒ/', meaning: '鼓励', example: 'My parents encourage me to try new things.', exampleCn: '我的父母鼓励我尝试新事物。' },
              { id: 2214, word: 'influence', phonetic: '/ˈɪnfluəns/', meaning: '影响', example: 'Friends can influence your decisions.', exampleCn: '朋友会影响你的决定。' },
              { id: 2215, word: 'opportunity', phonetic: '/ˌɑːpərˈtuːnəti/', meaning: '机会', example: 'Don\'t miss this great opportunity.', exampleCn: '不要错过这个大好的机会。' },
              { id: 2216, word: 'believe', phonetic: '/bɪˈliːv/', meaning: '相信', example: 'I believe you can do it.', exampleCn: '我相信你能做到。' },
              { id: 2217, word: 'protect', phonetic: '/prəˈtekt/', meaning: '保护', example: 'We should protect endangered animals.', exampleCn: '我们应该保护濒危动物。' },
              { id: 2218, word: 'purpose', phonetic: '/ˈpɜːrpəs/', meaning: '目的', example: 'What is the purpose of this meeting?', exampleCn: '这次会议的目的是什么？' },
              { id: 2219, word: 'respect', phonetic: '/rɪˈspekt/', meaning: '尊重', example: 'We should respect our elders.', exampleCn: '我们应该尊重长辈。' },
              { id: 2220, word: 'support', phonetic: '/səˈpɔːrt/', meaning: '支持', example: 'Thank you for your support.', exampleCn: '谢谢你的支持。' }
            ]
          }]
        }]
      }
      ...
      grade10: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 3001, word: 'academic', phonetic: '/ˌækəˈdemɪk/', meaning: '学术的', example: 'She has excellent academic records.', exampleCn: '她有优秀的学业成绩。' },
              { id: 3002, word: 'accurate', phonetic: '/ˈækjərət/', meaning: '准确的', example: 'Please give me an accurate answer.', exampleCn: '请给我一个准确的答案。' },
              { id: 3003, word: 'acknowledge', phonetic: '/əkˈnɑːlɪdʒ/', meaning: '承认；感谢', example: 'He acknowledged his mistake.', exampleCn: '他承认了他的错误。' },
              { id: 3004, word: 'acquire', phonetic: '/əˈkwaɪər/', meaning: '获得；习得', example: 'She acquired a good knowledge of English.', exampleCn: '她获得了良好的英语知识。' },
              { id: 3005, word: 'adolescent', phonetic: '/ˌædəˈlesnt/', meaning: '青少年', example: 'Adolescent years are full of changes.', exampleCn: '青少年时期充满了变化。' },
              { id: 3006, word: 'aggressive', phonetic: '/əˈɡresɪv/', meaning: '好斗的；进取的', example: 'An aggressive marketing strategy is needed.', exampleCn: '需要积极的营销策略。' },
              { id: 3007, word: 'ambitious', phonetic: '/æmˈbɪʃəs/', meaning: '有雄心的', example: 'She is an ambitious young lawyer.', exampleCn: '她是一位有抱负的年轻律师。' },
              { id: 3008, word: 'analyze', phonetic: '/ˈænəlaɪz/', meaning: '分析', example: 'We need to analyze the data first.', exampleCn: '我们需要先分析数据。' },
              { id: 3009, word: 'apparent', phonetic: '/əˈpærənt/', meaning: '明显的', example: 'It is apparent that he is not telling the truth.', exampleCn: '很明显他没有说实话。' },
              { id: 3010, word: 'appreciate', phonetic: '/əˈpriːʃieɪt/', meaning: '欣赏；感激', example: 'I really appreciate your help.', exampleCn: '我真的很感谢你的帮助。' },
              { id: 3011, word: 'appropriate', phonetic: '/əˈproʊpriət/', meaning: '适当的', example: 'Wear appropriate clothes for the interview.', exampleCn: '面试时穿合适的衣服。' },
              { id: 3012, word: 'associate', phonetic: '/əˈsoʊʃieɪt/', meaning: '联系；关联', example: 'People often associate red with danger.', exampleCn: '人们常把红色与危险联系起来。' },
              { id: 3013, word: 'atmosphere', phonetic: '/ˈætməsfɪr/', meaning: '气氛；大气', example: 'The restaurant has a cozy atmosphere.', exampleCn: '这家餐厅有一种舒适的氛围。' },
              { id: 3014, word: 'available', phonetic: '/əˈveɪləbl/', meaning: '可用的；有空的', example: 'Is this seat available?', exampleCn: '这个座位有人吗？' },
              { id: 3015, word: 'beneficial', phonetic: '/ˌbenɪˈfɪʃl/', meaning: '有益的', example: 'Exercise is beneficial to your health.', exampleCn: '运动对你的健康有益。' },
              { id: 3016, word: 'campaign', phonetic: '/kæmˈpeɪn/', meaning: '运动；活动', example: 'They launched a campaign to protect the ocean.', exampleCn: '他们发起了一场保护海洋的运动。' },
              { id: 3017, word: 'capable', phonetic: '/ˈkeɪpəbl/', meaning: '有能力的', example: 'She is capable of solving this problem.', exampleCn: '她有能力解决这个问题。' },
              { id: 3018, word: 'challenge', phonetic: '/ˈtʃælɪndʒ/', meaning: '挑战', example: 'This project is a real challenge.', exampleCn: '这个项目是一个真正的挑战。' },
              { id: 3019, word: 'characteristic', phonetic: '/ˌkærəktəˈrɪstɪk/', meaning: '特征', example: 'What are the characteristics of a good leader?', exampleCn: '一个好的领导者有什么特征？' },
              { id: 3020, word: 'civilization', phonetic: '/ˌsɪvələˈzeɪʃn/', meaning: '文明', example: 'Ancient Chinese civilization is fascinating.', exampleCn: '中国古代文明令人着迷。' }
            ]
          }]
        }]
      },
      grade11: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 3101, word: 'comprehensive', phonetic: '/ˌkɑːmprɪˈhensɪv/', meaning: '全面的', example: 'We need a comprehensive solution.', exampleCn: '我们需要一个全面的解决方案。' },
              { id: 3102, word: 'consequence', phonetic: '/ˈkɑːnsɪkwens/', meaning: '后果', example: 'Think about the consequences of your actions.', exampleCn: '想想你行为的后果。' },
              { id: 3103, word: 'conservative', phonetic: '/kənˈsɜːrvətɪv/', meaning: '保守的', example: 'He has a conservative view on education.', exampleCn: '他对教育持保守观点。' },
              { id: 3104, word: 'contemporary', phonetic: '/kənˈtempəreri/', meaning: '当代的', example: 'Contemporary art can be hard to understand.', exampleCn: '当代艺术可能很难理解。' },
              { id: 3105, word: 'controversial', phonetic: '/ˌkɑːntrəˈvɜːrʃl/', meaning: '有争议的', example: 'This is a controversial topic.', exampleCn: '这是一个有争议的话题。' },
              { id: 3106, word: 'cooperate', phonetic: '/koʊˈɑːpəreɪt/', meaning: '合作', example: 'We should cooperate with each other.', exampleCn: '我们应该相互合作。' },
              { id: 3107, word: 'correspond', phonetic: '/ˌkɔːrəˈspɑːnd/', meaning: '对应；通信', example: 'Does the punishment correspond to the crime?', exampleCn: '惩罚与罪行相称吗？' },
              { id: 3108, word: 'crucial', phonetic: '/ˈkruːʃl/', meaning: '关键的', example: 'This is a crucial moment in history.', exampleCn: '这是历史上的关键时刻。' },
              { id: 3109, word: 'demonstrate', phonetic: '/ˈdemənstreɪt/', meaning: '展示；证明', example: 'The experiment demonstrates the theory.', exampleCn: '实验证明了理论。' },
              { id: 3110, word: 'desperate', phonetic: '/ˈdespərət/', meaning: '绝望的；拼命的', example: 'He made a desperate attempt to escape.', exampleCn: '他拼命试图逃跑。' },
              { id: 3111, word: 'dilemma', phonetic: '/dɪˈlemə/', meaning: '困境', example: 'I am facing a moral dilemma.', exampleCn: '我面临一个道德困境。' },
              { id: 3112, word: 'distinguish', phonetic: '/dɪˈstɪŋɡwɪʃ/', meaning: '区分', example: 'Can you distinguish fact from opinion?', exampleCn: '你能区分事实与观点吗？' },
              { id: 3113, word: 'domestic', phonetic: '/dəˈmestɪk/', meaning: '国内的；家庭的', example: 'Domestic violence is a serious problem.', exampleCn: '家庭暴力是一个严重的问题。' },
              { id: 3114, word: 'dramatic', phonetic: '/drəˈmætɪk/', meaning: '戏剧性的；剧烈的', example: 'There has been a dramatic change in his attitude.', exampleCn: '他的态度发生了巨大的变化。' },
              { id: 3115, word: 'efficient', phonetic: '/ɪˈfɪʃnt/', meaning: '高效的', example: 'This new system is very efficient.', exampleCn: '这个新系统非常高效。' },
              { id: 3116, word: 'elaborate', phonetic: '/ɪˈlæbərət/', meaning: '精心制作的', example: 'She made an elaborate plan for the party.', exampleCn: '她为聚会制定了详尽的计划。' },
              { id: 3117, word: 'embarrass', phonetic: '/ɪmˈbærəs/', meaning: '使尴尬', example: 'I didn\'t mean to embarrass you.', exampleCn: '我不是故意让你难堪的。' },
              { id: 3118, word: 'enthusiasm', phonetic: '/ɪnˈθuːziæzəm/', meaning: '热情', example: 'He shows great enthusiasm for learning.', exampleCn: '他对学习表现出极大的热情。' },
              { id: 3119, word: 'evaluate', phonetic: '/ɪˈvæljueɪt/', meaning: '评估', example: 'Teachers evaluate students\' work regularly.', exampleCn: '教师定期评估学生的作业。' },
              { id: 3120, word: 'eventually', phonetic: '/ɪˈventʃuəli/', meaning: '最终', example: 'Eventually, everything worked out fine.', exampleCn: '最终，一切都好了起来。' }
            ]
          }]
        }]
      },
      grade12: {
        ...
        books: [{
          ...
          units: [{
            name: 'Unit 1',
            words: [
              { id: 3201, word: 'extraordinary', phonetic: '/ɪkˈstrɔːrdəneri/', meaning: '非凡的', example: 'She has an extraordinary memory.', exampleCn: '她有非凡的记忆力。' },
              { id: 3202, word: 'fundamental', phonetic: '/ˌfʌndəˈmentl/', meaning: '基本的', example: 'Freedom is a fundamental human right.', exampleCn: '自由是基本人权。' },
              { id: 3203, word: 'guarantee', phonetic: '/ˌɡærənˈtiː/', meaning: '保证', example: 'Hard work doesn\'t guarantee success.', exampleCn: '努力不一定保证成功。' },
              { id: 3204, word: 'illustrate', phonetic: '/ˈɪləstreɪt/', meaning: '说明；阐明', example: 'Let me illustrate with an example.', exampleCn: '让我用一个例子来说明。' },
              { id: 3205, word: 'inevitable', phonetic: '/ɪnˈevɪtəbl/', meaning: '不可避免的', example: 'Change is inevitable in life.', exampleCn: '变化在生活中是不可避免的。' },
              { id: 3206, word: 'innovation', phonetic: '/ˌɪnəˈveɪʃn/', meaning: '创新', example: 'Innovation drives economic growth.', exampleCn: '创新驱动经济增长。' },
              { id: 3207, word: 'interact', phonetic: '/ˌɪntərˈækt/', meaning: '互动', example: 'Children learn by interacting with others.', exampleCn: '孩子通过与他人互动来学习。' },
              { id: 3208, word: 'interpret', phonetic: '/ɪnˈtɜːrprɪt/', meaning: '解释；口译', example: 'How do you interpret this poem?', exampleCn: '你如何解读这首诗？' },
              { id: 3209, word: 'legislation', phonetic: '/ˌledʒɪsˈleɪʃn/', meaning: '立法', example: 'New legislation will be introduced next month.', exampleCn: '新的立法将于下月推出。' },
              { id: 3210, word: 'magnificent', phonetic: '/mæɡˈnɪfɪsnt/', meaning: '壮丽的', example: 'The view from the top is magnificent.', exampleCn: '从顶部看到的景色是壮丽的。' },
              { id: 3211, word: 'negotiate', phonetic: '/nɪˈɡoʊʃieɪt/', meaning: '谈判', example: 'We are negotiating a new contract.', exampleCn: '我们正在谈判一份新合同。' },
              { id: 3212, word: 'phenomenon', phonetic: '/fɪˈnɑːmɪnən/', meaning: '现象', example: 'This is a common social phenomenon.', exampleCn: '这是一种常见的社会现象。' },
              { id: 3213, word: 'prejudice', phonetic: '/ˈpredʒudɪs/', meaning: '偏见', example: 'We must fight against racial prejudice.', exampleCn: '我们必须反对种族偏见。' },
              { id: 3214, word: 'proportion', phonetic: '/prəˈpɔːrʃn/', meaning: '比例', example: 'A large proportion of the budget goes to education.', exampleCn: '预算的很大一部分用于教育。' },
              { id: 3215, word: 'psychology', phonetic: '/saɪˈkɑːlədʒi/', meaning: '心理学', example: 'She is studying psychology at university.', exampleCn: '她在大学学习心理学。' },
              { id: 3216, word: 'reputation', phonetic: '/ˌrepjuˈteɪʃn/', meaning: '声誉', example: 'The company has an excellent reputation.', exampleCn: '这家公司有极好的声誉。' },
              { id: 3217, word: 'revolution', phonetic: '/ˌrevəˈluːʃn/', meaning: '革命', example: 'The internet caused a revolution in communication.', exampleCn: '互联网引发了通信革命。' },
              { id: 3218, word: 'significant', phonetic: '/sɪɡˈnɪfɪkənt/', meaning: '重要的', example: 'This is a significant discovery.', exampleCn: '这是一个重要的发现。' },
              { id: 3219, word: 'sophisticated', phonetic: '/səˈfɪstɪkeɪtɪd/', meaning: '复杂的；精密的', example: 'This is a highly sophisticated system.', exampleCn: '这是一个高度精密的系统。' },
              { id: 3220, word: 'sustainable', phonetic: '/səˈsteɪnəbl/', meaning: '可持续的', example: 'Sustainable development is our goal.', exampleCn: '可持续发展是我们的目标。' }
            ]
          }]
        }]
      }
